...
export default function Navbar() {
    // const result = serverApi("categories");
    // console.log("Categories in Navbar:", result);
    ...
    // api implement 
    const [category, setCategory] = useState([{ id: 0, name: 'Loading...' }]);
    ...
    return (
        <>
            {loading ? <NavbarSkeleton /> : <nav className="w-full bg-white border-b border-gray-200 relative z-50">
              ...
              >
                ...
                >
                    ...
                    <div className="flex flex-col p-5 gap-4 text-gray-700">
                        ...
                        <Link to="/category/science" onClick={() => setSidebarOpen(false)}>
                            Science
                        </Link>
                        <Link to="/category/math" onClick={() => setSidebarOpen(false)}>
                            Math
                        </Link>
                        <Link to="/category/history" onClick={() => setSidebarOpen(false)}>
                            History
                        </Link>
                        <Link to="/category/tech" onClick={() => setSidebarOpen(false)}>
                            Tech
                        </Link>
