    ...
    <div className="  min-h-screen container mx-auto">
      <div className="">
        ...
        <div className="  mb-6">
          ...
          <div className="  rounded-xs overflow-hidden group shadow-sm border border-slate-100 min-w-full">
            {banner.image ? (
              <Image
                src={banner.image}
              ...
              <div className=" inset-0 flex items-center justify-center text-slate-300">
                <FiTag size={80} />
              </div>
            )}
