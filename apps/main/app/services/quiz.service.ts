...
class QuizService {
     ...
     */
    async getAll(params?: PaginationParams & { includeRelations?: boolean }): Promise<PaginatedResponse<Quiz>> {
     ...
     */
    async getByCategory(categoryId: string, params?: PaginationParams): Promise<PaginatedResponse<Quiz>> {
        const queryParams = new URLSearchParams();
