    ...
    <>
      ...
      <div className="flex flex-col items-center min-h-screen  py-12 px-4 max-w-6xl -mt-9 bg-white mx-auto rounded-md">
        ...
        {quizzes.questions.map((question: any, index: number) => (
          <div
            className="bg-[#F7F7F7] rounded-2xl shadow-md w-full max-w-lg p-8 relative mb-2"
            key={question.id}
          >
            {/* Back Button */}
            <button
            ...
            <p className="text-gray-600 text-sm text-center mb-8">
              ...
              office. The person does not have the MGL ID/Visitor/Staff/Vendor
              tag with him. What would you do?
            </p>
