      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading ? (
          ...
          questions.map((question: any) => (
            <div
              key={question.id}
              className="group bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300"
            >
              ...
              <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                <div className="flex items-center gap-2">
                  <div
                    className={`h-2 w-2 rounded-full ${question.isActive !== false ? "bg-emerald-500" : "bg-amber-500"}`}
                  ></div>
