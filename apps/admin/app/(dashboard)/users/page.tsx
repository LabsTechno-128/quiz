                    ...
                    <td className="px-6 py-5">
                      <div className="flex gap-2">
                        {user.roles.map((role: any) => (
                          <span
                            key={role}
                            className={`px-2 py-0.5 rounded-lg text-[10px] font-bold uppercase tracking-wider ${role.includes("admin") ? "bg-indigo-100 text-indigo-600" : "bg-slate-100 text-slate-500"}`}
                          >
                            {role.replace("_", " ")}
                          </span>
                        ))}
