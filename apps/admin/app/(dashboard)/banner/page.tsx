...
export default function BannerPage() {
  ...
  const [articles, setArticles] = useState<{id: string, title: string, subtitle: string, content: string, author: string, category: string, tags: string[], image: string, createdAt: string, updatedAt: string, isPublished: boolean, slug: string}[]>([]);
