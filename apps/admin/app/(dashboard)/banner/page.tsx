...
export default function BannerPage() {
  ...
  const fetchArticles = async (page = 1) => {
    ...
    try {
      ...
      let url = `/banners?page=${page}&limit=${limit}&search=${searchTerm}`;
      ...
      Toastify.Error("Failed to fetch Banner");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1 font-medium">
            Manage your editorial content and storytelling with professional
            precision.
          </p>
        </div>
        <Link
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-6 left-6">
                  <span
                    className={`px-5 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl backdrop-blur-md border border-white/20 ${article.isPublished ? "bg-emerald-500/90 text-white" : "bg-amber-500/90 text-white"}`}
                  >
              ...
              <div className="p-10 flex-1 flex flex-col">
                ...
                <p className="text-sm text-slate-400 font-medium mb-8 line-clamp-2 leading-relaxed">
                  {article.subtitle ||
                    "Exploring the depths of storytelling with professional insights."}
                </p>
          ...
          {!searchTerm && activeTab === "All Posts" && (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h3 className="text-2xl font-black text-slate-400 group-hover:text-slate-900 transition-colors tracking-tight">
                  Draft New Story
                </h3>
                <p className="text-sm text-slate-400 text-center mt-3 px-8 font-bold leading-relaxed opacity-60 group-hover:opacity-100">
                  Start writing your next masterpiece and engage your readers
                  today.
                </p>
              </div>
            </Link>
                  ...
                  >
                    <td className="px-10 py-6">
                      <div className="flex items-center gap-6">
                        ...
                        <div className="min-w-0">
                          <p className="text-base font-bold text-slate-900 group-hover:text-indigo-600 transition-colors truncate max-w-[200px] lg:max-w-[300px]">
                            {article.title}
                          </p>
                          <div className="flex items-center gap-2 mt-1">
                            <Globe className="h-3 w-3 text-slate-300" />
                            <code className="text-[10px] font-bold text-slate-400 truncate max-w-[200px]">
                              /{article.slug}
                            </code>
                          </div>
                        </div>
                    ...
                    <td className="px-6 py-6">
                      <div className="flex justify-center">
                        <span
                          className={`px-4 py-2 rounded-2xl text-[10px] font-black uppercase tracking-widest ${article.isPublished ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-amber-50 text-amber-600 border border-amber-100"}`}
                        >
                          {article.isPublished ? "Published" : "Draft"}
                        </span>
                      </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between bg-white px-12 py-8 rounded-[3rem] border border-slate-100 shadow-2xl shadow-slate-200/30 gap-6">
          <div className="flex items-center gap-4">
            ...
            <p className="text-sm font-black text-slate-400 tracking-tight">
              ...
              <span className="text-slate-900 opacity-60 font-bold">
